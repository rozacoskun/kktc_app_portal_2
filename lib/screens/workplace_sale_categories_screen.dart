...
class WorkplaceSaleCategoriesScreen extends StatelessWidget {
  const WorkplaceSaleCategoriesScreen({super.key});

  final List<String> _workplaceSaleSubcategories = const [
    'Apartman Dairesi',
    'Atölye',
    'Büfe',
    'Büro & Ofis',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        itemCount: _workplaceSaleSubcategories.length,
          ...
          return Container(
            ...
            child: ListTile(
              ...
              leading: Container(
                ...
                child: Icon(
                  _getIconForCategory(_workplaceSaleSubcategories[index]),
                  color: AppColors.primary,
                  size: 28,
                ),
              ),
              title: Text(
                _workplaceSaleSubcategories[index],
